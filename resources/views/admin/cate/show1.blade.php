                        ...
                        <tbody>
							...
							<tr id="{{$data["id"]}}">
								...
								<td class="text-center">
									...
									<!-- Show Edit Form -->
									<button class="btn_admin_action warning" data-toggle="modal" data-target="" onclick="edit_cate('{{$data["id"]}}')" id="edit_user"><span class="glyphicon glyphicon-pencil"></span></button>
									<!-- Show Delete Form -->
