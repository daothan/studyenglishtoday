...
@section('content')
	<!-- /.row -->
    <div class="row" id="guide_table">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2 align="center">DataTables show guides</h2>
                </div>
                <div class="panel-heading">
               		 <button class="btn_admin success" data-toggle="modal" id="add_guide"><span class="glyphicon glyphicon-plus"></span> ADD</button>
               		 <button class="btn_admin info" data-toggle="modal" id="view_guide"><span class="glyphicon glyphicon-list"></span> VIEW</button>
               		 <button class="btn_admin warning" data-toggle="modal" id="edit_guide"><span class="glyphicon glyphicon-pencil"></span> EDIT</button>
               		 <button class="btn_admin danger" data-toggle="modal" id="delete_guide"><span class="glyphicon glyphicon-trash"></span> DELETE</button>
    ...
    <div id="viewguide_errorModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="content modal_background">
                <div class="modal-title">
    ...
    @extends('admin.guide.guide_detail')
    @extends('admin.guide.guide_add')
    @extends('admin.guide.guide_edit')
    @extends('admin.guide.guide_delete')
