    ...
    <!-- View delete modal -->
	<div id="deletebannerModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="content modal_background">
                ...
                <div class="modal-body">
                    <strong class="text-info"><h3 align="center"><b><i>Are you sure you want to delete <br><span class="name_delete_banner text-info"></span></i><b></h3></strong>
                </div>
