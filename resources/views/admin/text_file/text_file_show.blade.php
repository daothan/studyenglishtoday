...
@section('content')
	...
	<!-- /.row -->
    <div class="row" id="file_table">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2 align="center">DataTables show text files</h2>
                </div>
                <div class="panel-heading">
               		 <button class="btn_admin success" data-toggle="modal" id="add_file"><span class="glyphicon glyphicon-plus"></span> ADD</button>
               		 <button class="btn_admin info" data-toggle="modal" id="view_file"><span class="glyphicon glyphicon-list"></span> VIEW</button>
               		 <button class="btn_admin warning" data-toggle="modal" id="edit_file"><span class="glyphicon glyphicon-pencil"></span> EDIT</button>
               		 <button class="btn_admin danger" data-toggle="modal" id="delete_file"><span class="glyphicon glyphicon-trash"></span> DELETE</button>
    ...
    <div id="view_file_error_Modal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="content modal_background">
                <div class="modal-title">
	...
	@extends('admin.text_file.text_file_add')
	@extends('admin.text_file.text_file_content')
	@extends('admin.text_file.text_file_edit')
	@extends('admin.text_file.text_file_delete')
@stop