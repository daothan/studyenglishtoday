				...
				<h3 class="w3ls-hdg">Practice Listening</h3><br>
					@foreach($audio as $detail)
						<div class="col-sm-5 col-xs-5 w3ltext-grids md_5 desktop">
							<h4 class="w3t-text" align="center" style="margin-bottom: 30px;"><a href="{{route('user.tittle_audio',[tittle($detail->tittle)])}}">{!!remove_dash(htmlspecialchars_decode($detail->tittle))!!} </a></h4>
							<div class="">
							...
							<h4 align="center" style="margin-top: 30px;"><a href="{{route('user.tittle_audio',[tittle($detail->tittle)])}}">Continue read..</a></h4>
						</div>
					@endforeach
				<div class="clearfix">
				</div>
