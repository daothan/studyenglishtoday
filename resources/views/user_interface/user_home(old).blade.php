		...
		<div class="container">
			...
			<br><br>
				...
				<a href="{{route('new_post')}}">
					<button class="button" class="pull-right" style="margin-top: 20px;"><span>View more...</span></button>
				</a>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div id="library_cate" class="grid_3 grid_5 w3-agileits">
				<a href="{{route('library')}}">
					<button class="button"><span>View More Library </span></button>
				</a><br><br><br>
						...
						@if($no==1)
							<div class="col-md-10 col-md-offset-1 md_10 level1">
								<div class="article_item_md10 level1_item">
									...
									<div class="article_info_md10 level1_info">
										<h3 class="w3t-text" align="center" style="margin-bottom: 20px;"><a href="{{route('detail_article',[$detail->type,$detail->alias])}}">{!!remove_dash(htmlspecialchars_decode($detail->tittle))!!}</a></h3>
									</div>
									<div class="article_info_md10 level1_introduce">
										<p align="center" class="overflow">{!!remove_dash(htmlspecialchars_decode($detail->introduce))!!}</p>
									</div>
							...
							@if($no==1)
								<div class="col-md-10 col-md-offset-1 md_10 level1">
									<div class="article_item_md10 level1_item">
										...
										<div class="article_info_md10 level1_info">
											<h3 class="w3t-text" align="center" style="margin-bottom: 20px;"><a href="{{route('tittle_audio',[tittle($audio->tittle)])}}">{!!remove_dash(htmlspecialchars_decode($audio->tittle))!!}</a></h3>
										</div>
										<div class="article_info_md10 level1_introduce">
		...
		<div class="container">
			<div id="reading_cate" class="grid_3 grid_5 w3-agileits">
				<a href="{{route('reading')}}">
					<button class="button"><span>View More Reading</span></button>
				</a><br><br><br>
